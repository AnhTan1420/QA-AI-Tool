        ...
        <section className="flex flex-col overflow-hidden">
          <div className="mb-4 flex shrink-0 gap-1.5 rounded-2xl border border-slate-200/70 bg-white/90 p-1.5 shadow-sm backdrop-blur-sm">
            ...
            >
              ...
              {workspace.isPending && <span className="h-2 w-2 animate-pulse rounded-full bg-amber-300" title={t.generateWorkspace.tabs.generatingTooltip} />}
            </button>
            <button
              type="button"
            ...
            >
              ...
              {workspace.review && workspace.rightTab !== 'review' && <span className="h-2 w-2 animate-pulse rounded-full bg-emerald-400" title={t.generateWorkspace.tabs.reviewReadyTooltip} />}
            </button>
          </div>
