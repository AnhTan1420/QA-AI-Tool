// ============================================================================
// File: document-extraction-agent.ts
// Chuc nang: Prompt cho Document Extraction Agent — "atomize" 1 tai lieu (text
// hoac anh) thanh danh sach DocumentAtom (lib/validators/document.ts) de
// Generation Agent map 100% vao test case (xem generation-agent.ts PHASE 0.5).
// ============================================================================
