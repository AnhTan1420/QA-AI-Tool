...
import TestCaseForm from '@/views/test-case-form';
import { getPriorityStyle } from '@/models/test-case-taxonomy';
import VersionHistory from '@/views/test-case/version-history';
import CommentsPanel from '@/views/test-case/comments-panel';
import AutomationPanel from '@/views/test-case/automation';
